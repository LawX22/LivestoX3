...
<template>
  <div class="h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-100 flex flex-col relative overflow-hidden">
    ...
    <div class="sticky top-0 z-40 px-4 md:px-6 pt-3">
      <div class="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white p-4 rounded-xl flex flex-col md:flex-row justify-between items-center gap-4 border border-green-200 shadow-lg backdrop-blur-sm">
        ...
        <div class="flex gap-3 mt-3 md:mt-0">
          ...
          <button
            @click="openAddModal"
            class="flex items-center gap-2 bg-white hover:bg-gray-100 text-green-700 px-4 py-2 rounded-lg transition-all shadow-sm hover:shadow-md border border-white/20"
          >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div class="flex-shrink-0 h-12 w-12 mr-4">
                          <img 
                            :src="getImageSource(animal.images)" 
                            alt="Animal" 
    ...
    <div v-if="isModalOpen" class="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
      ...
      <div class="relative bg-white rounded-xl overflow-hidden shadow-xl transform transition-all max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div>
              ...
              <div class="mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                  <span 
                    v-for="option in selectedAnimal.deliveryOptions" 
                    :key="option"
        ...
        <div class="bg-gray-50 px-6 py-4 flex flex-wrap gap-3 justify-end">
          ...
          <button
            @click="deleteAnimal(selectedAnimal.id)"
            type="button"
...
const selectedAnimal = ref<any>({});
const currentAnimalForEdit = ref<any>(null);
