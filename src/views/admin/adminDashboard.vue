    ...
    <main class="flex-1 p-8 overflow-auto">
      ...
      <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex items-center space-x-4">
          <div class="relative">
            <button class="p-2 rounded-full bg-white shadow hover:bg-gray-50 transition-all duration-200">
          ...
          <div class="flex items-center space-x-2">
            <div class="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-400 to-green-500 flex items-center justify-center text-white font-semibold">
              {{ userInitials }}
            </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          <div class="absolute inset-0 bg-gradient-to-r from-emerald-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <div class="relative z-10 flex items-start justify-between">
            <div>
              <p class="text-sm font-medium text-gray-500">Total Users</p>
              <h3 class="text-2xl font-bold mt-1 text-gray-800">{{ formatNumber(stats.totalUsers) }}</h3>
              <div class="flex items-center mt-2">
                <span :class="['text-xs font-medium px-1.5 py-0.5 rounded', stats.userChange >= 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800']">
        ...
        >
          <div class="absolute inset-0 bg-gradient-to-r from-blue-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <div class="relative z-10 flex items-start justify-between">
            <div>
              <p class="text-sm font-medium text-gray-500">Upgrade Requests</p>
              <h3 class="text-2xl font-bold mt-1 text-gray-800">{{ formatNumber(stats.requests) }}</h3>
              <div class="flex items-center mt-2">
                <span :class="['text-xs font-medium px-1.5 py-0.5 rounded', stats.requestChange >= 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800']">
        ...
        >
          <div class="absolute inset-0 bg-gradient-to-r from-amber-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <div class="relative z-10 flex items-start justify-between">
            <div>
              <p class="text-sm font-medium text-gray-500">Livestock Listings</p>
              <h3 class="text-2xl font-bold mt-1 text-gray-800">{{ formatNumber(stats.livestock) }}</h3>
              <div class="flex items-center mt-2">
                <span :class="['text-xs font-medium px-1.5 py-0.5 rounded', stats.livestockChange >= 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800']">
        ...
        >
          <div class="absolute inset-0 bg-gradient-to-r from-purple-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <div class="relative z-10 flex items-start justify-between">
            <div>
              <p class="text-sm font-medium text-gray-500">Reports Generated</p>
              <h3 class="text-2xl font-bold mt-1 text-gray-800">{{ formatNumber(stats.reports) }}</h3>
              <div class="flex items-center mt-2">
                <span :class="['text-xs font-medium px-1.5 py-0.5 rounded', stats.reportChange >= 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800']">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex space-x-2">
              <button class="text-xs px-2 py-1 rounded bg-gray-100 text-gray-600 hover:bg-gray-200">Monthly</button>
              <button class="text-xs px-2 py-1 rounded hover:bg-gray-100 text-gray-600">Yearly</button>
            </div>
          </div>
          <div class="h-64">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div class="flex items-center justify-between mb-4">
            ...
            <router-link to="/upgradeRequests" class="text-xs text-emerald-600 hover:text-emerald-700 flex items-center">
              View all
      ...
      <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between mb-4">
          ...
          <router-link to="/admin/activity" class="text-xs text-emerald-600 hover:text-emerald-700 flex items-center">
            View all
            <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
