<!-- LivestockCard.vue | LivestockManagement -->
<template>
  <!-- Card View (Default) -->
    ...
    <div class="p-4 flex-1 flex flex-col">
      ...
      <div class="flex justify-between items-start mb-3 min-h-[52px]">
        ...
        <div class="flex-1 pr-3 overflow-hidden">
          <h3 class="font-bold text-sm text-emerald-700 leading-tight line-clamp-2 cursor-pointer hover:text-emerald-800 transition-colors"
            @click="$emit('openModal', animal)" :title="animal.title">
            {{ animal.title }}
          </h3>
        </div>
        ...
        <div class="flex flex-col items-end text-right flex-shrink-0 w-[110px]">
          <!-- Date -->
          <div class="text-xs text-gray-500 flex items-center gap-1 mb-1 whitespace-nowrap">
      ...
      <!-- Description Section - FIXED with ellipsis -->
      <div class="mb-3 min-h-[32px]">
        <p class="text-xs text-gray-600 line-clamp-2 leading-relaxed" :title="animal.description">
          {{ animal.description }}
        </p>
      </div>
    ...
    <tr class="hover:bg-gray-50/50 transition-colors duration-200 border-b border-gray-200">
      ...
      <td class="px-4 py-3">
        <div class="flex flex-col">
          <div class="text-sm font-semibold text-gray-900 mb-1 cursor-pointer hover:text-green-600 transition-colors line-clamp-1" 
