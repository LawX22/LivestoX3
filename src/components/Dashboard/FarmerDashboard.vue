      ...
      <div class="bg-white/95 backdrop-blur-xl rounded-lg shadow-md border border-white/30 p-3 transition-all hover:shadow-lg">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-lg font-bold text-gray-900 mt-0.5">₱{{ formatNumber(stats.totalRevenue || 0) }}</p>
            <div class="mt-1 flex items-center text-[10px] text-gray-500">
              <span class="inline-flex items-center px-1 py-0.5 rounded text-[10px] font-medium bg-green-100 text-green-800">
                <svg class="-ml-0.5 mr-0.5 h-2.5 w-2.5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd" />
          ...
          <div class="p-4">
            ...
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div class="bg-gray-50 rounded-lg p-3">
                <p class="text-[10px] font-medium text-gray-500">Avg. Selling Price</p>
              ...
              <div class="bg-gray-50 rounded-lg p-3">
                <p class="text-[10px] font-medium text-gray-500">Total Units Sold</p>
                <p class="text-base font-bold text-gray-900 mt-0.5">{{ stats.totalUnits || 0 }}</p>
                <p class="text-[10px] text-gray-500 mt-0.5">+{{ stats.unitsGrowth || 0 }}% from last month</p>
              </div>
              <div class="bg-gray-50 rounded-lg p-3">
                <p class="text-[10px] font-medium text-gray-500">Conversion Rate</p>
                <p class="text-base font-bold text-gray-900 mt-0.5">{{ stats.conversionRate || '0.0' }}%</p>
                <p class="text-[10px] text-gray-500 mt-0.5">+{{ stats.conversionGrowth || 0 }}% from last month</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-lg shadow-md overflow-hidden border border-white/30 transition-all hover:shadow-lg">
          ...
          <div class="p-4">
            <div class="space-y-4">
              <div>
                <h4 class="text-[10px] font-medium text-gray-700 mb-2">Livestock Distribution</h4>
...
const createRevenueChart = () => {
  ...
  const revenueData = [45000, 52000, 48000, 61000, 55000, props.stats.totalRevenue || 58000]
