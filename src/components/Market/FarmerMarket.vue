      ...
      <div class="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white p-4 rounded-xl flex flex-row justify-between items-center gap-4 border border-green-200 shadow-lg backdrop-blur-sm">
        ...
        <div class="flex items-center min-w-0">
          ...
          <div class="min-w-0">
            ...
            <p class="text-green-100 text-sm opacity-90 truncate">Discover quality livestock from verified farmers</p>
          </div>
        </div>

        <!-- Right side - Post Livestock Button -->
...
const contactFarmer = (animal: Animal) => {
  showToastNotification(`Contact information for ${animal.farmer.farmName} has been copied to clipboard: ${animal.farmer.contact}`);
