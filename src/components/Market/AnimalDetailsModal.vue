      ...
      <div class="sticky top-0 z-50 px-4 md:px-6 pt-4 pb-2 bg-gradient-to-br from-emerald-50/95 via-teal-50/95 to-green-100/95 backdrop-blur-md border-b border-white/40">
        <div class="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white p-4 rounded-xl flex flex-row justify-between items-center gap-4 border border-green-200 shadow-lg backdrop-blur-sm">
          ...
          <div class="flex items-center min-w-0">
            ...
            <button 
              @click="$emit('close')" 
              class="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-xl flex items-center justify-center mr-3 backdrop-blur-sm shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer"
              title="Go back"
            >
              <svg
            ...
            <div class="min-w-0">
              <h1 class="text-xl font-bold text-white truncate cursor-default">{{ animal.title || getModalTitle(animal) }}</h1>
              ...
              <div class="relative rounded-xl overflow-hidden shadow-lg hover:shadow-xl border border-white/60 hover:border-green-300/60 transition-all duration-300 bg-white/95 backdrop-blur-sm group">
                ...
                <div class="relative h-64 sm:h-80 lg:h-96 xl:h-[28rem]">
                  ...
                  <div v-if="animal.images.length > 1" class="absolute inset-0 flex items-center justify-between px-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button 
                      @click="previousImage"
                      class="w-12 h-12 bg-white/95 backdrop-blur-md hover:bg-white text-gray-800 rounded-xl flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110 border border-white/40 cursor-pointer"
                    >
                  ...
                  <div v-if="animal.images.length > 1" class="absolute top-4 right-4 z-20">
                    <div class="bg-white/95 backdrop-blur-md px-3 py-1.5 rounded-full shadow-lg border border-white/40 cursor-default">
                  ...
                  <div class="absolute bottom-4 left-4 z-20">
                    <div :class="`px-3 py-1.5 rounded-full shadow-lg border font-bold text-sm cursor-default ${getTypeBadgeClassForImage(animal.type)}`">
                      {{ animal.type }}
                    </div>
                  </div>
                </div>
              ...
              <div class="bg-white/95 backdrop-blur-sm rounded-xl p-5 border border-white/60 shadow-md hover:shadow-lg transition-all duration-300">
                ...
                <div class="space-y-4">
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <!-- Type -->
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200/60 h-20 flex flex-col justify-center cursor-default">
                    ...
                    <!-- Breed -->
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200/60 h-20 flex flex-col justify-center cursor-default">
                      <div class="flex items-center justify-center gap-2 mb-1">
                        <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <!-- Weight -->
                    <div class="bg-gradient-to-br from-purple-50 to-violet-50 rounded-lg p-4 border border-purple-200/60 h-20 flex flex-col justify-center cursor-default">
                      <div class="flex items-center justify-center gap-2 mb-1">
                    ...
                    <!-- Age -->
                    <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-lg p-4 border border-emerald-200/60 h-20 flex flex-col justify-center cursor-default">
                      <div class="flex items-center justify-center gap-2 mb-1">
                    ...
                    <!-- Gender -->
                    <div class="bg-gradient-to-br from-pink-50 to-rose-50 rounded-lg p-4 border border-pink-200/60 h-20 flex flex-col justify-center cursor-default">
                      <div class="flex items-center justify-center gap-2 mb-1">
                  ...
                  <div class="bg-gradient-to-br from-gray-50 to-slate-50 rounded-lg p-4 border border-gray-200/60">
                    ...
                    <p class="text-gray-700 leading-relaxed text-sm cursor-text select-text">{{ animal.description }}</p>
                  </div>
                </div>
              </div>
            ...
            <div class="lg:col-span-2 space-y-4">
              ...
              <div class="bg-white/95 backdrop-blur-sm rounded-xl p-4 border border-white/60 shadow-md hover:shadow-lg transition-all duration-300">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-slate-50 rounded-lg p-4 border border-gray-200/60 mb-4">
                  <div class="flex items-center justify-between mb-3">
                    <span class="text-sm font-semibold text-gray-700 cursor-default">Quantity</span>
                  ...
                  <div class="flex items-center gap-3">
                    <button 
                      ...
                      class="w-10 h-10 bg-white border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 cursor-pointer"
                    >
                      <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 bg-white border border-gray-300 rounded-lg px-4 py-2 text-center">
                      <input 
                        ...
                        :min="1" 
                        :max="animal.quantity"
                        class="w-full text-center font-bold text-gray-800 bg-transparent outline-none cursor-text"
                ...
                <div v-if="animal.status === 'Low Stock'" class="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-lg p-3 border border-yellow-200/60">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-semibold text-yellow-800 cursor-default">Limited stock available</span>
                  </div>
                </div>
                ...
                <div v-if="animal.status === 'Out of Stock'" class="bg-gradient-to-r from-red-50 to-pink-50 rounded-lg p-3 border border-red-200/60">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-semibold text-red-800 cursor-default">Currently out of stock</span>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white/95 backdrop-blur-sm rounded-xl p-4 border border-white/60 shadow-md hover:shadow-lg transition-all duration-300">
                ...
                <div class="mb-4 space-y-3">
                  <h4 class="text-md font-bold text-gray-800 flex items-center gap-2 cursor-default">
                    <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-3 border border-blue-200/60">
                    <div class="flex items-center gap-3">
                      ...
                      <div class="flex-1">
                        <p class="font-bold text-blue-800 text-sm cursor-text select-text">{{ animal.farmer.contact }}</p>
                        <p class="text-blue-600 text-xs cursor-default">Mobile Number</p>
                      </div>
                      <button 
                        @click="callFarmer"
                        class="p-2 bg-blue-100 hover:bg-blue-200 rounded-lg transition-colors duration-200 cursor-pointer"
                        title="Call farmer"
                      >
                        <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  ...
                  <div v-if="animal.farmer.email" class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-3 border border-green-200/60">
                    <div class="flex items-center gap-3">
                      ...
                      <div class="flex-1 min-w-0">
                        <p class="font-bold text-green-800 text-sm truncate cursor-text select-text">{{ animal.farmer.email }}</p>
                        <p class="text-green-600 text-xs cursor-default">Email Address</p>
                      </div>
                      <button 
                        @click="emailFarmer"
                        class="p-2 bg-green-100 hover:bg-green-200 rounded-lg transition-colors duration-200 cursor-pointer"
                        title="Send email"
                      >
                        <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                ...
                <div class="space-y-3">
                  ...
                  <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-3 border border-orange-200/60">
                    <div class="flex items-start gap-3">
                      ...
                      <div class="flex-1">
                        <p class="font-bold text-orange-800 text-sm leading-relaxed cursor-text select-text">{{ formatLocation(animal) }}</p>
                        <p class="text-orange-600 text-xs mt-1 cursor-default">Farm Address</p>
                      </div>
                    </div>
                  </div>
                </div>
