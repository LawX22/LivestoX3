<!-- components/TransactionDetailsModal.vue -->
<template>
                ...
                <div class="flow-root">
                  ...
                  <div class="py-6 border-b border-gray-200">
                    ...
                    <div class="flex items-start">
                      <div class="flex-shrink-0">
                        <img class="h-12 w-12 rounded-full border border-gray-200" :src="transaction.seller.avatar" alt="">
                      </div>
                      <div class="ml-4">
                        <h4 class="text-sm font-medium text-gray-900">{{ transaction.seller.name }}</h4>
                        <p class="text-sm text-gray-500">{{ transaction.seller.farm }}</p>
                        <p class="text-sm text-gray-500">{{ transaction.seller.contact }}</p>
                        <p class="text-sm text-gray-500">{{ transaction.seller.location }}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="py-6 border-b border-gray-200">
                    ...
                    <dl class="space-y-4">
                      ...
                      <div v-if="transaction.trackingNumber" class="flex items-center justify-between">
                        <dt class="text-sm text-gray-600">Tracking Number</dt>
                        <dd class="text-sm font-medium text-gray-900">{{ transaction.trackingNumber }}</dd>
                      </div>
                      <div v-if="transaction.estimatedDelivery" class="flex items-center justify-between">
                        <dt class="text-sm text-gray-600">Estimated Delivery</dt>
                        <dd class="text-sm font-medium text-gray-900">{{ formatDate(transaction.estimatedDelivery) }}</dd>
                      </div>
                    </dl>
                  </div>
                  ...
                  <div class="py-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                      <p class="text-sm text-gray-700">{{ transaction.message || "No message provided." }}</p>
                    </div>
                  </div>
                </div>
              </div>
