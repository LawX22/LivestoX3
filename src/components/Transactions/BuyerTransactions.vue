  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <div class="p-4 md:p-6 border-b border-gray-200 bg-white">
      <div class="flex items-center gap-4">
        <div>
          <h1 class="text-2xl font-bold text-green-800">Your Purchase History</h1>
          <p class="text-gray-500 mt-1">View your livestock inquiries and purchases</p>
        </div>
      </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900 mt-1">₱98,750</p>
            </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="transaction in filteredTransactions" :key="transaction.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10">
                      <img class="h-10 w-10 rounded-full object-cover" :src="transaction.seller.avatar" alt="">
                    </div>
                    <div class="ml-4">
                      <div class="text-sm font-medium text-gray-900">{{ transaction.seller.name }}</div>
                      <div class="text-sm text-gray-500">{{ transaction.seller.contact }}</div>
                    </div>
                  </div>
                </td>
            ...
            <div class="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                    ...
                    <div class="py-6 border-b border-gray-200">
                      ...
                      <div class="flex items-start">
                        <div class="flex-shrink-0">
                          <img class="h-12 w-12 rounded-full" :src="selectedTransaction.seller.avatar" alt="">
                        </div>
                        <div class="ml-4">
                          ...
                          <p class="text-sm text-gray-500">{{ selectedTransaction.seller.address }}</p>
                          <p class="text-sm text-gray-500 mt-2">
                            <span class="font-medium">Farm:</span> {{ selectedTransaction.seller.farmName }}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                ...
                <div class="mt-6 flex space-x-4">
                  ...
                  <button 
                    v-if="selectedTransaction.status === 'Accepted'"
                    @click="markAsCompleted(selectedTransaction.id)"
                  ...
                  <button 
                    ...
                    @click="contactSeller(selectedTransaction.seller)"
                    class="flex-1 bg-blue-600 border border-transparent rounded-md py-3 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
      ...
      transactions: [
        ...
        },
        {
          ...
          seller: {
            ...
            address: '456 Swine St, Bulacan',
            farmName: 'Santos Pig Farm',
        ...
        },
        {
          ...
          seller: {
            id: 203,
            name: 'Carlos Mendoza',
            contact: '+63 919 987 6543',
            address: '789 Hillside, Rizal',
            farmName: 'Mendoza Goat Farm',
        ...
        },
        {
          ...
          livestock: {
            ...
            description: 'Free-range chickens, excellent egg layers',
          ...
          seller: {
            ...
            address: '321 Poultry Ave, Pampanga',
          ...
          paymentMethod: 'Cash on Delivery',
          deliveryMethod: 'Pickup',
          message: 'Interested in bulk purchase if price can be lowered.'
        },
        {
          id: 'TXN-78905',
          livestock: {
